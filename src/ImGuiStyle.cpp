...
void SetupImGuiStyle()
{
	...
	style.Colors[ImGuiCol_Text] = ImVec4(0.8980392f, 0.8980392f, 0.8980392f, 1.0f);
	...
	style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.46666667f, 0.46666667f, 0.6862745f, 0.4f);
	style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.41960785f, 0.40784314f, 0.6392157f, 0.69f);
	style.Colors[ImGuiCol_TitleBg] = ImVec4(0.26666668f, 0.26666668f, 0.5372549f, 0.83f);
	style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.31764707f, 0.31764707f, 0.627451f, 0.87f);
	...
	style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.40784314f, 0.3882353f, 0.8f, 0.6f);
	style.Colors[ImGuiCol_CheckMark] = ImVec4(0.8980392f, 0.8980392f, 0.8980392f, 0.5f);
	style.Colors[ImGuiCol_SliderGrab] = ImVec4(1.0f, 1.0f, 1.0f, 0.3f);
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.40784314f, 0.3882353f, 0.8f, 0.6f);
	style.Colors[ImGuiCol_Button] = ImVec4(0.34901962f, 0.4f, 0.60784316f, 0.62f);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.4f, 0.47843137f, 0.70980394f, 0.79f);
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.45882353f, 0.5372549f, 0.8f, 1.0f);
	style.Colors[ImGuiCol_Header] = ImVec4(0.4f, 0.4f, 0.8980392f, 0.45f);
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.44705883f, 0.44705883f, 0.8980392f, 0.8f);
	style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.5294118f, 0.5294118f, 0.8666667f, 0.8f);
	...
	style.Colors[ImGuiCol_Tab] = ImVec4(0.33333334f, 0.33333334f, 0.68235296f, 0.786f);
	style.Colors[ImGuiCol_TabHovered] = ImVec4(0.44705883f, 0.44705883f, 0.8980392f, 0.8f);
	style.Colors[ImGuiCol_TabActive] = ImVec4(0.40392157f, 0.40392157f, 0.7254902f, 0.842f);
	...
	style.Colors[ImGuiCol_TableHeaderBg] = ImVec4(0.26666668f, 0.26666668f, 0.3764706f, 1.0f);
